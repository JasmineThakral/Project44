...
var playerArrows = [];
var board1, board2;
var boardImage, boardImg, baseImg, arrowImg, playerImg, playerArcherImg;
...
function setup() {
  ...
  board1=createSprite(width/2,500);
board1.addImage(boardImg);
board1.velocityY = 4;
board1.scale = 0.03

board2=createSprite(width/2,500);
...
function draw() {
  ...
  board1.bounceOff(edges);
  board2.bounceOff(edges);
